package me.wmorales01.blunixteleport.util;
...
public class MessageManager {
	...
	private static BlunixTeleport plugin;
	
	public MessageManager() {
		plugin = BlunixTeleport.getPlugin(BlunixTeleport.class);
	}
