...
import com.blunix.blunixteleport.commands.CommandGenerateLocations;
...
public class BlunixTeleport extends JavaPlugin {
	...
	public void onDisable() {
		...
		if (!playersInContract.isEmpty()) {
			dataManager.savePlayerContracts();
		}
	}
	...
	private void registerCommands() {
		...
		subCommands.put("wild", new CommandWild(this));
		subCommands.put("cooldown", new CommandCooldown(this));
		subCommands.put("generatelocations", new CommandGenerateLocations(this));
...
//		subCommands.put("sethome", new CommandSetHome(this));
	...
	public FileConfiguration getRandomLocationData() {
		return randomLocationManager.getConfig();
	}
	
	public void saveRandomLocationData() {
		randomLocationManager.saveConfig();
	}
